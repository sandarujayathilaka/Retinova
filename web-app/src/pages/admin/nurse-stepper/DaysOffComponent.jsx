    ...
    <div className="space-y-4">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-slate-500">
          Add days when the nurse will not be available. This could include holidays, personal time
            ...
            <div key={day.id} className="flex items-center gap-2">
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {day.repeatYearly && (
                    <div className="flex items-center gap-1 bg-violet-50 text-violet-700 px-2 py-1 rounded-full">
      ...
      <div className="flex justify-center mt-4">
        <Button
          type="button"
          variant="outline"
          className="border-dashed border-slate-300 text-slate-600 hover:text-violet-700 hover:border-violet-700 hover:bg-violet-50"
          onClick={e => {
            e.preventDefault(); // Prevent form submission
            resetModal();
            setIsAdding(true);
      ...
      >
        ...
        <DialogContent className="sm:max-w-[450px]">
          <DialogHeader>
            <DialogTitle className="text-violet-700 flex items-center">
            ...
            <DialogDescription>
              {isEditing
                ...
                : "Add a period when the nurse will be unavailable"}
            </DialogDescription>
          </DialogHeader>
