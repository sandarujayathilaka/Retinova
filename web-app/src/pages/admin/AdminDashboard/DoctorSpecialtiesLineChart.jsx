...
// const DoctorSpecialtiesLineChart = ({ doctors, doctorChartView, setDoctorChartView }) => {
...
//       const key = doctorChartView === "specialties" ? doctor.specialty.toLowerCase() : doctor.type.toLowerCase();
//       if (key) {
...
//   return (
//     <Card className="shadow-lg rounded-2xl overflow-hidden bg-white transition-all duration-200 hover:shadow-xl h-full">
...
//         <Select value={doctorChartView} onValueChange={setDoctorChartView} className="mb-4">
...
// export default DoctorSpecialtiesLineChart;
...
const DoctorSpecialtiesLineChart = ({ doctors, doctorChartView, setDoctorChartView }) => {
  const title = doctorChartView === "specialties" ? "Doctor Specialties Trend" : "Doctor Types Trend";
  const description = doctorChartView === "specialties" ? "Distribution Analysis" : "Full-time vs Part-time Analysis";
      ...
      <CardContent className="p-4 flex flex-col h-full">
          ...
          {chartData.length === 0 ? (
            <div className="flex items-center justify-center h-full text-center text-gray-500">
              <div className="flex flex-col items-center gap-2">
                <FaUserDoctor className="h-10 w-10 text-gray-300" />
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip 
                  ...
                  formatter={(value, name) => [`${value} doctors`, name === "count" ? "Count" : name]}
        ...
        {chartData.length > 0 && (
          <div className="mt-4 pt-2 border-t border-gray-100 text-xs text-gray-500 text-center">
            Total: {doctors.length} doctors across {chartData.length} {doctorChartView === "specialties" ? "specialties" : "types"}
          </div>
        )}
      </CardContent>
    </Card>
