...
//   return (
//     <Card className="bg-white rounded-xl overflow-hidden border border-blue-100 transition-shadow duration-200">
...
//                           <div className="text-center bg-white p-2 rounded-lg border border-blue-100">
...
/**
 * RecordItem component displays a single medical record
