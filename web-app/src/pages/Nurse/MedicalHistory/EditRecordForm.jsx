...
//   const [localLoading, setLocalLoading] = useState(false); // Local loading state for this form
...
//       onSave().finally(() => setLocalLoading(false)); // Reset loading after save completes
//     }
//   };
...
//                   </div>
//                 ) : (
//                   <a href={path} target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline text-sm truncate max-w-xs">
