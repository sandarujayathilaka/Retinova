...
//   // Use the custom hook for patient data
//   const {
//     patients,
//     loading,
//     error,
//     pagination,
//     changePage,
//   } = usePatientData("Monitoring", {
//     searchTerm,
//     gender: selectedGender,
//   });

//   // Memoize the handleViewPatient function to prevent unnecessary re-renders
//   const handleViewPatient = useMemo(() => (patient) => {
//     const patientId = patient.patientId;
//     navigate(`/monitoring-patients/view/${patientId}`);
//   }, [navigate]);
...
//               selectedGender={selectedGender}
//               setSelectedGender={setSelectedGender}
//               setPagination={(newPaginationState) => changePage(newPaginationState.currentPage)}
//               title=""
