...
//             <DoctorSummary doctors={doctors} doctorFilter={doctorFilter} setDoctorFilter={setDoctorFilter} className="h-full flex flex-col" />
//           </div>
//           <div className="h-full">
//             <NurseSummary nurses={nurses} nurseFilter={nurseFilter} setNurseFilter={setNurseFilter} className="h-full flex flex-col" />
//           </div>
//           <div className="h-full">
//             <PatientSummary patients={patients} patientFilter={patientFilter} setPatientFilter={setPatientFilter} className="h-full flex flex-col" />
//           </div>
//           <div className="h-full">
//             <StaffSchedule doctors={doctors} nurses={nurses} selectedDate={selectedDate} setSelectedDate={setSelectedDate} className="h-full flex flex-col" />
//           </div>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//           <DoctorsStatusPieChart data={doctorsStatusData} config={doctorsStatusConfig} doctors={doctors} />
//           <NursesStatusPieChart data={nursesStatusData} config={nursesStatusConfig} nurses={nurses} />
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//           <DoctorSpecialtiesChart doctors={doctors} doctorChartView={doctorChartView} setDoctorChartView={setDoctorChartView} />
//           <NurseSpecialtiesChart nurses={nurses} nurseChartView={nurseChartView} setNurseChartView={setNurseChartView} />
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//           <DoctorSpecialtiesLineChart doctors={doctors} doctorChartView={doctorChartView} setDoctorChartView={setDoctorChartView} />
//           <NurseSpecialtiesLineChart nurses={nurses} nurseChartView={nurseChartView} setNurseChartView={setNurseChartView} />
//         </div>
