...
// import CustomDatePicker from "../../Nurse/CommonFiles/CustomDatePicker"; // Adjust the import path
// import { Activity,CalendarClockIcon } from "lucide-react";

// // New DayWrapper component to handle tooltip positioning with hooks
...
//       // Determine the best position to avoid clipping and overlap with calendar
...
//         ${isWorking && !isWorkingAndOff ? "bg-green-100" : ""} 
//         ${isWorkingAndOff ? "bg-red-100" : ""}`}
//     >
//       <span className="text-sm font-medium text-gray-800">{day}</span>
//       {/* Tooltip with detailed staff schedules */}
//       <div className="tooltip absolute invisible group-hover:visible bg-white text-black text-sm rounded py-2 px-3 shadow-lg border border-gray-200">
//         <div className="font-semibold mb-1">Staff Details for {date.toLocaleDateString()}</div>
//         {schedules.length > 0 ? (
...
//           ))
//         ) : (
//           <div className="text-gray-600">No staff scheduled for this date.</div>
//         )}
//       </div>
//     </div>
//   );
...
// const StaffSchedule = ({ doctors, nurses, selectedDate, setSelectedDate }) => {
...
//           <CalendarClockIcon className="h-5 w-5" /> Staff Schedule
//         </div>
//       </CardHeader>
...
import React, { useRef, useEffect } from "react";
import { Card, CardHeader, CardContent } from "@/components/ui/card";
import CustomDatePicker from "../../Nurse/CommonFiles/CustomDatePicker";
import { CalendarClock, Clock, User, BadgeCheck, AlertTriangle } from "lucide-react";

// DayWrapper component to handle tooltip positioning with hooks
const DayWrapper = ({ day, date, isWorking, isWorkingAndOff, schedules }) => {
  const dayRef = useRef(null);
