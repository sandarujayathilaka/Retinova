...
//   placeholderText,
//   renderDayContents,
//   inline = false, // Default to false (input field mode)
// }) => {
//   return (
//     <>
//       <DatePicker
...
//         className={
//           !inline
//             ? "w-full bg-white border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 text-gray-700"
//             : ""
//         }
...
//         inline={inline} // Pass the inline prop to react-datepicker
//       />
//       <style>{`
//         .custom-datepicker {
      ...
      <DatePicker
        ...
        className={
          !inline
            ...
            : `${className} mx-auto` // Center the inline calendar horizontally
        }
        placeholderText={placeholderText}
        dateFormat="yyyy-MM-dd"
        popperPlacement="top-start"
