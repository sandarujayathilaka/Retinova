...
//   return (
//     <Card className="shadow-lg rounded-xl overflow-hidden bg-white transition-all duration-300 border-none">
...
//         </div>
//         <CardDescription className="text-blue-100">Patient Distribution by Category</CardDescription>
//       </CardHeader>
...
//       {totals.overall > 0 && (
//         <CardFooter className="flex flex-col items-center gap-2 text-sm p-4 bg-gray-50 border-t border-gray-100">
//           <div className="font-semibold text-indigo-900">Total: {totals.overall} patients</div>
//           <div className="flex flex-wrap justify-center gap-3">
//             {defaultCategories.map((category) => (
//               totals[category] > 0 && (
//                 <div key={category} className="flex items-center bg-white px-2 py-1 rounded-full shadow-sm">
//                   <div
...
//       <CardHeader className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white p-4">
//         <div className="text-lg font-semibold flex items-center gap-2">
//           <PieChart className="h-5 w-5" /> Disease Progression
//         </div>
//         <CardDescription className="text-blue-100">Analysis by Stage Over Time</CardDescription>
//       </CardHeader>
...
//             {defaultStages.map((stage) => (
//               totals[stage] > 0 && (
//                 <div key={stage} className="flex items-center bg-white px-2 py-1 rounded-full shadow-sm">
//                   <div
//                     className="w-3 h-3 rounded-full mr-2"
...
//               />
//               <span className="text-gray-700">New: {totals["New Patients"]}</span>
//             </div>
//             <div className="flex items-center bg-white px-2 py-1 rounded-full shadow-sm">
//               <div
//                 className="w-3 h-3 rounded-full mr-2"
...
//               />
//               <span className="text-gray-700">Existing: {totals["Existing Patients"]}</span>
//             </div>
//           </div>
//         </CardFooter>
//       )}
...
// Simplified Doctor and Nurse chart implementations that match dashboard styling


// export function NurseTypeAndSpecialtyBarChart({ data, view = "types" }) {
//   return (
//     <div className="text-center py-8">
//       <p className="text-gray-500">Nurse Type and Specialty chart would appear here</p>
//     </div>
//   );
// }
...
//           <div className="font-semibold text-indigo-900 text-sm mb-1">Total: {totals.overall} doctors</div>
//           <div className="flex flex-wrap justify-center gap-3">
//             {view === "types" ? (
//               <>
//                 {types.map(type => (
//                   totals[type] > 0 && (
//                     <div key={type} className="flex items-center bg-white px-3 py-1.5 rounded-lg">
//                       <div
//                         className="w-3 h-3 rounded-full mr-2"
//                         style={{ backgroundColor: typeColors[type] }}
//                       />
//                       <span className="text-sm">
//                         <span className="font-medium capitalize">{type}</span>: {totals[type]}
//                       </span>
//                     </div>
//                   )
//                 ))}
...
//               specialties.map((specialty, index) => (
//                 totals[specialty] > 0 && (
//                   <div key={specialty} className="flex items-center bg-white px-3 py-1.5 rounded-lg">
//                     <div
//                       className="w-3 h-3 rounded-full mr-2"
//                       style={{ backgroundColor: specialtyColors[index % specialtyColors.length] }}
//                     />
//                     <span className="text-sm">
//                       <span className="font-medium capitalize">{specialty}</span>: {totals[specialty]}
//                     </span>
//                   </div>
//                 )
//               ))
...
//       {totals.overall > 0 && (
//         <CardFooter className="flex flex-col items-center gap-3 p-4 bg-gray-50 border-t border-gray-100">
//           <div className="font-semibold text-indigo-900 text-sm mb-1">Total: {totals.overall} nurses</div>
//           <div className="flex flex-wrap justify-center gap-3">
//             {view === "types" ? (
//               <>
//                 {types.map(type => (
