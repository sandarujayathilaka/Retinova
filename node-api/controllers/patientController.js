...
/**
 * @route   POST /api/patients/:patientId/diagnoses/:diagnoseId/tests
 * @desc    Add a new test to the 'recommend.tests' array of a specific diagnosis
 *          - Validates that testName is provided
 *          - Finds patient by `patientId` (not MongoDB _id)
 *          - Locates the diagnosis by its ID within the patient's diagnoseHistory
 *          - Adds a new test with default status "Pending" and timestamp
 */
